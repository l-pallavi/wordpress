...
<div id="wrap" class="wpos-solutions-features-page">
	...
	<style>
		...
		.igsp-deal-offer-wrap{position: relative;padding:0 1.25rem;margin-bottom: 1rem;border: 1px solid transparent;border-radius: 0.25rem; color: #000;background-color: #6c63ff;border-color: #6c63ff;margin-top: 20px;}
		.igsp-deal-offer{display:flex;align-items: center;}
		.igsp-inn-deal-offer{flex-basis:60%; padding:0 20px; text-align:left;}
		.igsp-deal-free-offer{ margin: 20px; text-align:center; }
		.igsp-inn-deal-hedding{color:#fff;}
		.igsp-inn-deal-hedding span{color:#ffef00;}
		.igsp-sf-free-btn{display: inline-block; font-size: 18px; padding: 10px 25px; border-radius: 100px;  background-color: #ffef00 ; border-color: #ffef00 ; color: #000; font-weight: 600; text-decoration: none;}
		.igsp-sf-free-btn:hover, .igsp-sf-free-btn:focus{ color: #000; }
