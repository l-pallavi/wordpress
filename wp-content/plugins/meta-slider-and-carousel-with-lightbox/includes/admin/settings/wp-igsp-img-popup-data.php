		...
		<table class="form-table">
			...
			<tr class="wp-igsp-pro-feature">
				...
				<td>
					...
					<span class="description"><?php esc_html_e('Enter image description.', 'meta-slider-and-carousel-with-lightbox'); ?></span><strong><?php echo sprintf( __( ' Try This <a href="%s" target="_blank">Features in Essential Bundle Free For 5 Days.', 'meta-slider-and-carousel-with-lightbox'), WP_IGSP_PLUGIN_LINK_UNLOCK); ?></strong>
				</td>
			</tr>
			...
			<tr class="wp-igsp-pro-feature">
				...
				<td>
					...
					<span class="description"><?php esc_html_e('Enter image link.', 'meta-slider-and-carousel-with-lightbox'); ?></span><strong><?php echo sprintf( __( ' Try This <a href="%s" target="_blank">Features in Essential Bundle Free For 5 Days.', 'meta-slider-and-carousel-with-lightbox'), WP_IGSP_PLUGIN_LINK_UNLOCK); ?></strong>
				</td>
			</tr>
