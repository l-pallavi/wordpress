<div class="wpsr-ig-post-media <?php echo esc_attr($animation_img_class . ' ' . $media_type); ?>"
 id="wpsr-video-play-<?php echo esc_attr($index); ?>" >
    <?php if ($media_type === 'VIDEO') { ?>
        <video preload="none" class="wpsr-ig-post-video" poster="<?php echo esc_url($thumbnail_url); ?>" <?php echo ($template_meta["post_settings"]["display_mode"] === 'inline') ? 'controls=controls loop="" webkit-playsinline="" playsinline=""' : ''?>>
